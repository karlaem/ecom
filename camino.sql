...
-- Tiempo de generación: 09-11-2020 a las 06:56:15
...
INSERT INTO `clients` (`id`, `first_name`, `last_name`, `email`, `age`, `countryId`, `image`, `phone`) VALUES
(1, 'karla', 'mercado', 'kaarla.e.mg@gmail.com', 24, 144, '', 528111204452),
(2, 'nicole', 'shouten', 'nicole@mail.com', 24, 67, '', 123456789),
(4, 'karla', 'mercado', 'kaarla.e.mg@gmail.com', 24, 144, 'assets/1604894875831bee.png', 528111204452);
...
CREATE TABLE IF NOT EXISTS `country` (
  ...
  `name` varchar(64) NOT NULL COMMENT 'ISO 3166-1 official English short name (Gazetteer order, w/o diacritics)',
  PRIMARY KEY (`id`),
...
(1, 'karla', '$2y$10$.48/vqh6mAImOh11ZffBNuFSFNrTyrwFMLHS2/80y6ZdZa.dX7G4y');
COMMIT;
